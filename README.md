...
| Project | Description |
|---------|-------------|
| [pong](https://github.com/antoniosdimidgamedev/pong) | Terminal Pong — local PvP, CPU AI, LAN multiplayer, web dashboard, zero dependencies |
| [pong-indev](https://github.com/antoniosdimidgamedev/pong-indev) | Classic Pong — terminal and browser versions (in development) |
| [Shooter](https://github.com/antoniosdimidgamedev/Shooter) | Forest Strike: Survival Ops — low-poly FPS with bullet physics, sound, and wave survival |
